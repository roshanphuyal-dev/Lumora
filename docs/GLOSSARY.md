...
- **Task Type** — the enum the Orchestration Layer uses to decide routing (e.g. `teach`, `format`, `retrieve`) — declared by feature code, never a hardcoded provider choice.
