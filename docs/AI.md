...
|---|---|
| **Gemini 3.5 Flash** (primary) | Teaching, personalized explanations, quiz generation/grading, feedback, LaTeX generation, study planning, adaptive tutoring |
